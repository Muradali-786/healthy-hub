      ...
      appBar: AppBar(
        actions: [
          PopupMenuButton<String>(
            ...
            onSelected: (value) {
              if (value == "Mood Analyzer") {
                // Navigate to Mood Analyzer screen
                // You can implement similar navigation for Mood Analyzer if you have that screen
              } else if (value == "Calorie Tracker") {
              ...
              children: [
                RichText(
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      TextSpan(
                        text: 'AI Assisted Smart Health Hub',
                        style: TextStyle(
                          color: AppColors.blueColor,
                ...
                Center( // This ensures the second text is centered
                  child: RichText(
